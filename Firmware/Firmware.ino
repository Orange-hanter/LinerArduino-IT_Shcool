...
// Pin Definitions
const int DCMOTORDRIVERL298_PIN_INT1 = 3;
const int DCMOTORDRIVERL298_PIN_ENB = 5;
const int DCMOTORDRIVERL298_PIN_INT2 = 4;
const int DCMOTORDRIVERL298_PIN_ENA = 2;
const int DCMOTORDRIVERL298_PIN_INT3 = 7;
const int DCMOTORDRIVERL298_PIN_INT4 = 6;

const int IRLINEFOLLOW_1_PIN_OUT = A0;
const int IRLINEFOLLOW_2_PIN_OUT = A2;
const int IRLINEFOLLOW_3_PIN_OUT = A3;


// Global variables and defines
const int timeout = 10000 / 2;     // timeout of 5 sec
char menuOption = 0;
long time0;
...
void loop()
{
  ...
  if (menuOption == '1') {
    ...
    //Read IR Line Follower Sensor. irLineFollow_2Var will be '0' if a black line was detected
    bool irLineFollow_2Var = digitalRead(IRLINEFOLLOW_3_PIN_OUT);
    Serial.print(F("LineFollow: ")); Serial.println(irLineFollow_2Var);
...
char menu()
{
  ...
  Serial.println(F("(4) IR Line Track Follower Sensor #3"));
